...
UPDATE: выяснилась причина проблем с nginx. Vegeta на дефолтных настройках, начинает создавать много коннешеннов, пытаясь поднять rps, в ситуации когда он ниже целевого. Nginx открывает тысячи конкурентных конекшенов с клиентом и это замедляет работу как nginx, так и самого vegeta. Пофиксилось ограничением количества коннешенов до 400 на стороне vegeta.
...
mysql может утилизировать несколько ядер при чтении из одной таблицы.
